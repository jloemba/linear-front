    ...
    <div className="flex flex-col gap-4 border-b border-stone-200 px-6 py-5 sm:flex-row sm:items-center sm:justify-between">
      ...
      <div className="flex flex-wrap items-center gap-2">
        ...
        <button
          type="button"
          onClick={onAddNode}
          className="rounded-full border border-emerald-200 bg-sky-50 px-2 py-1 text-sm font-semibold text-sky-700 transition hover:border-emerald-300 hover:bg-emerald-100"
        >
          {editor.addNode}
        </button>
      </div>
        ...
        {nodes.map((node, nodeIndex) => {
          ...
          return (
            <article
              ...
              key={node.id}
              className="scroll-mt-24 rounded-[24px] border border-stone-200 bg-stone-50/70 p-5"
            >
              <div className="mb-5 flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
                <div className="flex items-start gap-3">
                  <button
                    ...
                    className="mt-1 flex h-10 w-10 shrink-0 items-center justify-center rounded-full border border-stone-200 bg-white text-lg font-semibold text-stone-600 transition hover:border-stone-300 hover:text-stone-900"
                  >
                    {isCollapsed ? "+" : "−"}
                  </button>
                  <div>
